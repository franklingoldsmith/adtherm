...
#This is the one used for H_Cu111_ex1
import torch
import common_dft as pytorch
from common_dft import *

def V_pytorch(adsorbate, models):
    ...
    pot_E=pytorch.eval_energy_joint(rhombus_coord, models, eps=0.02)
...
def q_MCsampling(adsorbate, surf, ads, METHOD, T_array):
    ...
    while conv_param > adsorbate.q_accuracy:# and points_needed<3000:
        ...
        if min_dist < min_cutoff or max_dist>max_cutoff: #retranslate the ads in the plane
            ...
            gamma = ads.gamma
            dz_array.append(dz)
            potential_E_J = V_pytorch(adsorbate, models)
