...
dh = 0.01
max_r_fcc = 0.680986 #for fcc position
new_r = 1.000000
dh_angle=0.01/max_r_fcc*new_r #displacement in each direction

origin_energy= -366855.730636 #eV - DFT energy at fcc origin

ndim = 5
hessian=np.zeros((ndim,ndim))

#counter for displacements (60 in this case)
count=0
...
for i in range(ndim):
    for j in range(ndim):
        ...
        if i>j:
            ...
            for disp in range(4): #because 4 displacements per matrix element
